...
from numi.agent.context_manager import (
    ContextManager,
    ConversationState,
    InvestigationState,
    PendingApproval,
...
from numi.agent.llm.fallback import fallback_notice_text
...
from numi.agent.reply import AgentReply, ApprovalCard
...
from numi.common.models.catalog import LeastPrivilegeFinding
...
from numi.common.models.tool import OperationType, ToolCallRequest, ToolCallResponse, ToolCallStatus
...
# sending "@Numi DBA Agent /models" — the ordinary way of addressing the
...
_HELP_TEXT = (
    "I'm Numi, your AI DBA assistant. I can investigate database health, "
    ...
    async def _finalize_conclude(
        ...
        *,
        ...
        if not final_chance and investigation.pending_verification is not None:
            ...
            # -> NUMI REPORTS THE ACTUAL OUTCOME" principle (README.md's
